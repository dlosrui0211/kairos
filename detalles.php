...
<div class="detalles-pc">
    ...
    <div class="detalles-contenedor">
        ...
        <div class="detalles-info">
            <div class="detalles-titulo">EA SPORTS FC 26</div>

            <div class="detalles-datos">
                <div><strong>Género:</strong> Deportes</div>
                <div><strong>Modo:</strong> Singleplayer / Multijugador Online</div>
            </div>

            <div class="detalles-descripcion">
                EA SPORTS FC 26 es la próxima evolución del fútbol con mecánicas renovadas, física mejorada, nuevo sistema de impacto corporal y jugabilidad realista para experiencias competitivas online y offline.
            </div>

            <div class="detalles-precio">39.99€</div>
            <a class="detalles-boton">AÑADIR AL CARRITO</a>
        </div>
    ...
    <div class="requs-contenedor">
        <div class="requs-bloque">
            <div class="requs-sub">MÍNIMOS</div>
            <ul>
        ...
        <div class="requs-bloque">
            <div class="requs-sub">RECOMENDADOS</div>
            <ul>
